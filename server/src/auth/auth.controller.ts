...
export class AuthController {
    ...
    @ApiOperation({ summary: 'Log in with phone number and OTP to receive tokens' })
    @ApiOkResponse({
    ...
    @Post('login')
    @HttpCode(HttpStatus.OK)
    async login(@Body() loginRequestDto: LoginRequestDto): Promise<AuthTokensDto> {
    ...
    @Post('refresh')
    @HttpCode(HttpStatus.OK)
    async refreshTokens(@GetUser() user: JwtPayloadWithRefreshToken): Promise<AuthTokensDto> {
