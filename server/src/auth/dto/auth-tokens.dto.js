    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _accessToken_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'A short-lived JSON Web Token for authenticating API requests.',
                    example: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwicGhvbmVOdW1iZXIiOiI5ODc2NTQzMjEwIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
                })];
            _refreshToken_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'A long-lived JSON Web Token used to obtain a new access token.',
                    example: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwicGhvbmVOdW1iZXIiOiI5ODc2NTQzMjEwIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
                })];
