...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
         ...
         * @returns The user object or null if not found.
         */
        UsersService_1.prototype.findByPhoneNumber = function (phoneNumber) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findUnique({
        ...
        /**
         * Creates a new user. Primarily used on first login.
         * @param phoneNumber The user's 10-digit phone number.
         * @returns The newly created user object.
         */
        UsersService_1.prototype.createUser = function (phoneNumber) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         */
        UsersService_1.prototype.update = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
